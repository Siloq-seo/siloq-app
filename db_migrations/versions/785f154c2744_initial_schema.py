...
Revision ID: 785f154c2744
Revises: 
Create Date: 2026-01-28 02:31:11.005572
...
def upgrade() -> None:
    ...
    sa.Column('site_type', sa.Enum('LOCAL_SERVICE', 'ECOMMERCE', name='site_type_enum'), nullable=True),
    ...
    sa.Column('status', sa.Enum('draft', 'pending_review', 'approved', 'published', 'decommissioned', 'blocked', name='content_status'), nullable=False),
    ...
    sa.Column('project_id', sa.UUID(), nullable=False),
    sa.Column('plan_key', sa.Enum('trial', 'blueprint', 'operator', 'agency', 'empire', name='plan_type_enum'), nullable=False),
