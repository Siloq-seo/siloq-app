...
async def lifespan(app: FastAPI):
    ...
    # Startup: only initialize Redis and queues.
    # Database migrations are NOT run automatically; they must be executed manually
    # using Alembic CLI commands (e.g., `alembic upgrade head`).
